...
const MuiTableTrans: React.FC<Props> = ({ columns, fetchData, onAdd, onHistory }) => {
    ...
    const handleHistory = async (row: any) => {
        try {
            ...
            console.error("Failed to History data:", error);
        }
    };
                        ...
                        <TableBody>
                            {data.map((row) => (
                                <TableRow key={row.id}>
                                    ...
                                    <TableCell>
                                        <IconButton sx={{ color: "green" }} onClick={() => onAdd && onAdd(row)}>
                                            <FaDolly />
                                        </IconButton>
                                        <IconButton sx={{ color: "blue" }} onClick={() => handleHistory(row)}>
                                            <HistoryIcon />
                                        </IconButton>
                                    </TableCell>
                                </TableRow>
