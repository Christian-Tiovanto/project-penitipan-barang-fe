...
import { FaSave, FaArrowLeft, FaBalanceScale, FaInfoCircle } from "react-icons/fa";
import InputField from "../../../components/inputfield";
import { useNavigate, useParams } from "react-router";
import { useToast } from "../../../contexts/toastContexts";
import InputFieldNumber from "../../../components/inputfieldnumber";
import { FaBox, FaClipboardList, FaTag, FaWeightHanging } from "react-icons/fa6";
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        try {
            ...
            if (validateForm()) {
                ...
                await updateProductById(ProductId, form)
    ...
    return (
        <div className="container mt-4">
            <div className="d-flex justify-content-between align-items-center p-3 mb-3">
                <Breadcrumb title="Master" items={["Product", "Edit Product"]} />
