...
import {
    ...
    TablePagination, IconButton, Box, Button, TextField, InputAdornment
} from "@mui/material";
...
const MuiTable: React.FC<Props> = ({ columns, data, onEdit, onDelete, onAdd }) => {
                    ...
                    {filteredData.slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage).map((row) => (
                        <TableRow key={row.id}>
                            ...
                            <TableCell>
                                ...
                                <IconButton sx={{ color: "red" }} onClick={() => onDelete && onDelete(row)}>
                                    <DeleteIcon />
                                </IconButton>
                            </TableCell>
                        </TableRow>
