...
const CreateCustomerPaymentForm: React.FC = () => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        try {
            ...
            if (validateForm()) {
                await createCustomerPayment(parseInt(form.customerId), parseInt(form.paymentMethodId), form.charge, form.status, form.min_pay)
    ...
    return (
        <div className="container mt-4">
            <div className="d-flex justify-content-between align-items-center p-3 mb-3">
                <Breadcrumb title="Master" items={["Customer Payment", "Create Customer Payment"]} />
