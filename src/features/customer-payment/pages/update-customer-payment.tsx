...
import { createCustomerPayment, getCustomerPaymentById, updateCustomerPaymentById } from "../services/customer-payment.service";
    ...
    return (
        <div className="container mt-4">
            <div className="d-flex justify-content-between align-items-center p-3 mb-3">
                <Breadcrumb title="Master" items={["Customer Payment", "Edit Customer Payment"]} />
